About quest-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/quest-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/erdc/quest

Documentation: https://quest.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3305&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/quest-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `quest` can be installed with `conda`:
...
It is possible to list all of the versions of `quest` available on your platform with `conda`:
...
```
mamba search quest --channel conda-forge
```
...
mamba repoquery search quest --channel conda-forge

# List packages depending on `quest`:
mamba repoquery whoneeds quest --channel conda-forge

# List dependencies of `quest`:
mamba repoquery depends quest --channel conda-forge
```
